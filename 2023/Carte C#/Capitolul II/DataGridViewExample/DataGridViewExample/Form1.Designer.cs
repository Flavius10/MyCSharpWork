namespace DataGridViewExample
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sportDataSet = new DataGridViewExample.SportDataSet();
            this.sportBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.sportTableAdapter = new DataGridViewExample.SportDataSetTableAdapters.SportTableAdapter();
            ...
            this.dataGridView1.DataSource = this.sportBindingSource;
            ...
            this.idSportivDataGridViewTextBoxColumn.ReadOnly = true;
            // 
